...
const { getPuzzle, checkAnswer, solveSudoku, KINDS } = require('../wisdom_puzzle');
...
test('공백·쉼표·전각 숫자·소문자 허용, 배열/과도한 길이/중복/누락 답안 거부', () => {
    const cipher = getPuzzle('2026-09-16', 'formats', 74);
    const order = getPuzzle('2026-09-17', 'formats', 74);
