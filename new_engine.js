        ...
        if (id && password) {
            try {
                ...
                if (!loginToken) {
                    ...
                    console.log("받은 쿠키:", Object.keys(sessionCookies).join(', '));
                    
                    const hasDcidCookie = Object.keys(sessionCookies).some(key => 
                        key.includes('ci_c') || key.includes('PHPSESSID') || key.includes('csid')
                    );
