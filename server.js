...
@media(max-width:860px){.rank-me{grid-template-columns:46px 50px 1fr;grid-template-areas:'mrk mttl mmain' 'mrk mttl mval';gap:4px 12px;padding:13px 15px}.rank-me .vl{font-size:16px}.rank-me .total{display:none}.rank-ttl{height:36px;max-width:50px}}
.title-badge{height:16px;width:auto;vertical-align:-3px;margin-right:4px;image-rendering:auto}
.rank-list{display:flex;flex-direction:column;background:linear-gradient(180deg,rgba(8,11,26,.7),rgba(4,6,18,.6));border:1px solid rgba(255,255,255,.07);border-radius:16px;overflow:hidden;box-shadow:0 8px 26px rgba(0,0,0,.32)}
.rank-row{display:grid;grid-template-columns:62px 64px 1fr auto;grid-template-areas:'rk ttl main val';align-items:center;gap:14px;padding:13px 18px;border-bottom:1px solid rgba(255,255,255,.06);cursor:pointer;transition:background .12s}
.rank-row:last-child{border-bottom:none}.rank-row:hover{background:rgba(88,101,242,.12)}.rank-row.me{background:rgba(251,191,36,.09);box-shadow:inset 3px 0 0 #fbbf24}
.rank-row .rk{grid-area:rk;font-size:16px;font-weight:800;color:#a5b4fc;text-align:center}.rank-row .rk.gold{color:#fbbf24;font-size:23px}.rank-row .rk.silver{color:#e2e8f0;font-size:21px}.rank-row .rk.bronze{color:#f59e0b;font-size:19px}
.rank-row .ttl{grid-area:ttl;display:flex;align-items:center;justify-content:center}.rank-row .nm{grid-area:main;font-weight:700;color:#f1f5f9;min-width:0;overflow:hidden;text-overflow:ellipsis}.rank-row .lv{font-size:12px;color:#94a3b8;margin-left:7px;font-weight:600}.rank-row .vl{grid-area:val;font-weight:800;color:#fbbf24;font-variant-numeric:tabular-nums;font-size:15px;white-space:nowrap}
@media(max-width:860px){.rank-row{grid-template-columns:44px 50px 1fr;grid-template-areas:'rk ttl main' 'rk ttl val';gap:3px 11px;padding:11px 14px}.rank-row .rk{font-size:15px}.rank-row .rk.gold{font-size:20px}.rank-row .rk.silver{font-size:19px}.rank-row .rk.bronze{font-size:18px}.rank-row .vl{font-size:14px}.rank-row .lv{display:block;margin:2px 0 0 0}.rank-ttl{height:36px;max-width:50px}}
...
.dex-filter-bar{display:flex;align-items:center;gap:10px;margin:0 0 14px;padding:10px 12px;background:rgba(4,6,18,.58);border:1px solid rgba(255,255,255,.07);border-radius:12px}.dex-filter-bar[hidden]{display:none}.dex-filter-label{font-size:12px;font-weight:800;color:#94a3b8;white-space:nowrap}.dex-rarity-select{min-width:150px;padding:8px 34px 8px 11px;border:1px solid rgba(129,140,248,.28);border-radius:9px;background:#10172a;color:#e2e8f0;font-size:13px;font-weight:700;cursor:pointer}.dex-rarity-select:focus{outline:2px solid rgba(129,140,248,.42);outline-offset:1px}.dex-filter-count{margin-left:auto;color:#64748b;font-size:12px;font-weight:700;white-space:nowrap}@media(max-width:640px){.dex-rarity-select{min-width:0;flex:1}}
...
.auction-bar{display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;margin-bottom:14px}.auction-grid{display:flex;flex-direction:column;gap:8px}.auc-card{position:relative;display:grid;grid-template-columns:64px minmax(0,1fr) auto;align-items:center;gap:12px;padding:10px 12px;background:rgba(4,6,18,.65);border:1px solid rgba(255,255,255,.07);border-radius:12px;cursor:pointer;transition:transform .12s,box-shadow .12s,border-color .12s}.auc-card:hover{transform:translateX(2px);box-shadow:0 10px 28px rgba(0,0,0,.4),0 0 0 1px rgba(88,101,242,.3);border-color:rgba(88,101,242,.45)}.auc-card.mine{border-color:#fbbf24}.auc-thumb{aspect-ratio:3/4;display:grid;place-items:center;background:rgba(15,23,42,.7);border-radius:10px;font-size:64px;overflow:hidden}.auc-thumb.square{aspect-ratio:1/1;position:relative;background:transparent}.auc-card>.auc-thumb{width:64px;height:64px;aspect-ratio:auto}.auc-card>.auc-thumb.square{aspect-ratio:auto}.auc-thumb img{width:100%;height:100%;object-fit:contain}.auc-thumb.card{background:transparent}.auc-frame{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;z-index:1}.auc-icon,.auc-item-img{position:relative;z-index:2}.auc-icon{font-size:64px;line-height:1;text-shadow:0 4px 14px rgba(0,0,0,.6)}.auc-card .auc-icon{font-size:32px}.auc-item-img{width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 6px 10px rgba(0,0,0,.55))}.currency-img{width:20px;height:20px;object-fit:contain;vertical-align:-4px;margin-right:5px}.auc-info{min-width:0;display:grid;gap:3px}.auc-title{min-width:0;display:flex;align-items:center;gap:7px}.auc-name{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:800;font-size:15px;color:#f8fafc;line-height:1.3}.auc-sub,.auc-seller{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.auc-sub{font-size:12px;color:#94a3b8}.auc-price{display:flex;align-items:center;justify-self:end;white-space:nowrap;font-weight:800;font-size:15px;color:#fbbf24}.auc-seller{font-size:11px;color:#64748b}.auc-mine-badge{flex-shrink:0;background:#fbbf24;color:#0f172a;font-size:10px;font-weight:800;padding:2px 6px;border-radius:999px}.tag{display:inline-block;padding:3px 8px;border-radius:999px;background:#263244;color:#cbd5e1;font-size:12px;font-weight:700}.tag.rarity{color:#fff;background:var(--rar,#334155)}.tag.on{background:#14532d;color:#bbf7d0}.empty,.loading{padding:24px;text-align:center;color:#94a3b8}.err{color:#f87171}.section-row{display:grid;grid-template-columns:1fr 1fr;gap:18px}
.auc-card{border-left:3px solid var(--rar,rgba(255,255,255,.07))}
.shop-buy-item-row .auc-thumb{width:64px;flex-shrink:0}.shop-buy-item-row .auc-icon{font-size:34px}
.sort-select{padding:8px 10px;background:rgba(4,6,14,.85);border:1px solid rgba(255,255,255,.1);border-radius:8px;color:#e5e7eb;font-size:13px;outline:none;cursor:pointer;transition:border-color .15s}.sort-select:focus{border-color:rgba(99,102,241,.6)}
@media(min-width:980px){.auction-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}}
@media(max-width:640px){.auction-bar .actions{flex:1 1 100%;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px}.auction-bar .actions .search-input{width:100%;min-width:0}.auction-bar .actions .seg{grid-column:1/-1;flex-wrap:nowrap;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch}.auction-bar .actions .seg::-webkit-scrollbar{display:none}.auction-bar .actions .seg button{flex:0 0 auto}.auction-bar .actions>.primary{grid-column:1/-1}.modal-bg{align-items:flex-end;padding:0}.modal,.modal.wide{width:100%;max-width:100%;max-height:92vh;max-height:92dvh;border-radius:20px 20px 0 0;padding:20px 18px calc(18px + env(safe-area-inset-bottom));animation:sheetUp .22s ease}}
@keyframes sheetUp{from{transform:translateY(28px);opacity:.5}to{transform:none;opacity:1}}
.tag.rarity.rarity-mythic{background:linear-gradient(120deg,#38bdf8,#8b5cf6,#c084fc,#38bdf8);background-size:240% 240%;box-shadow:0 0 12px rgba(125,211,252,.45);animation:mythicGradientShift 3.2s ease-in-out infinite}
.rarity-mythic-card{border-color:#a78bfa!important;border-left-color:#7dd3fc!important;animation:mythicCardGlow 2.6s ease-in-out infinite}
img[src*="%5B%EC%9E%A5%EB%B9%84%5D%EC%8B%A0%ED%99%94.png"]{animation:mythicFrameGlow 2.4s ease-in-out infinite;will-change:filter}
@keyframes mythicGradientShift{0%,100%{background-position:0% 50%}50%{background-position:100% 50%}}
...
.patch-post:last-child{border-bottom:none}.patch-post:hover{background:rgba(88,101,242,.1)}
.patch-post .pp-main{min-width:0}.patch-post .pp-title{font-size:16px;font-weight:800;color:#f1f5f9;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.patch-post .pp-date{font-size:12px;color:#94a3b8;margin-top:4px}
.patch-post .pp-cmt{display:inline-flex;align-items:center;gap:5px;font-size:13px;font-weight:700;color:#a5b4fc;background:rgba(88,101,242,.12);padding:5px 11px;border-radius:999px;white-space:nowrap}
.patch-back{display:inline-flex;align-items:center;gap:7px;align-self:flex-start;background:rgba(20,28,46,.8);color:#cbd5e1;border:1px solid rgba(255,255,255,.08);padding:8px 14px;border-radius:10px;font-weight:700;font-size:13px;cursor:pointer;transition:all .15s}.patch-back:hover{background:rgba(88,101,242,.18);color:#fff}
.patch-detail{display:grid;gap:16px}.patch-detail-head{padding-bottom:14px;border-bottom:1px solid rgba(255,255,255,.08)}.patch-detail-title{font-size:22px;font-weight:900;color:#f8fafc;line-height:1.3}.patch-detail-date{font-size:12px;color:#94a3b8;margin-top:7px}
.markdown-body{line-height:1.65;color:#dbeafe;word-break:break-word}.markdown-body h1,.markdown-body h2,.markdown-body h3{color:#f8fafc;margin:14px 0 8px}.markdown-body p{margin:8px 0}.markdown-body ul,.markdown-body ol{padding-left:22px}.markdown-body code{background:rgba(15,23,42,.9);border:1px solid rgba(148,163,184,.18);border-radius:6px;padding:1px 5px}.markdown-body pre{background:#020617;border:1px solid rgba(148,163,184,.18);border-radius:10px;padding:12px;overflow:auto}
.patch-comments{display:grid;gap:12px;padding-top:6px;border-top:1px solid rgba(255,255,255,.08)}.patch-comments-h{font-size:15px;font-weight:800;color:#f8fafc;display:flex;align-items:center;gap:8px}.patch-comments-h span{color:#a5b4fc}
.reply-list{display:grid;gap:8px}.reply-item{display:grid;gap:6px;padding:11px 13px;background:rgba(2,6,23,.5);border:1px solid rgba(148,163,184,.1);border-radius:11px;transition:border-color .12s,background .12s}.reply-item.child{margin-left:22px;background:rgba(2,6,23,.32)}.reply-item.active{border-color:rgba(88,101,242,.5);background:rgba(88,101,242,.07)}
.reply-head{cursor:pointer}.reply-head:hover .reply-replybtn{color:#c7d2fe}.reply-meta{font-size:12px;color:#94a3b8}.reply-meta b{color:#f8fafc}.reply-text{white-space:pre-wrap;line-height:1.5;color:#dbeafe}.reply-replybtn{font-size:11px;font-weight:700;color:#818cf8;margin-top:3px;transition:color .12s}
.reply-box{display:grid;gap:8px;margin-top:4px}.reply-box textarea{min-height:72px;resize:vertical;line-height:1.5}.reply-box .actions{display:flex;gap:8px;justify-content:flex-end}
@media(max-width:860px){.patch-post{padding:14px 16px}.patch-post .pp-title{font-size:15px;white-space:normal}.patch-detail-title{font-size:19px}.reply-item.child{margin-left:12px}}
...
@media(max-width:520px){header{padding:10px 8px;gap:6px}h1{font-size:clamp(16px,5vw,20px)}.top-left{gap:8px}.bar{gap:5px}.who{max-width:30vw;font-size:clamp(10px,2.8vw,12px)}.subnav-bar{padding:0 8px}.tab-label{display:none}.tab-icon-wrap{width:36px;height:36px;border-radius:12px}.tab-icon-wrap svg{width:20px;height:20px}.search-input{flex:1;min-width:0}.auc-card{grid-template-columns:52px minmax(0,1fr) auto;gap:8px;padding:8px}.auc-card>.auc-thumb{width:52px;height:52px;border-radius:8px}.auc-card .auc-icon{font-size:26px}.auc-name{font-size:13px}.auc-sub{font-size:11px}.auc-seller{font-size:10px}.auc-price{font-size:13px}.auc-price .currency-img{width:16px;height:16px;margin-right:3px}.auc-mine-badge{font-size:9px;padding:2px 5px}.shop-grid{grid-template-columns:repeat(2,1fr);gap:8px}.shop-currency-chip{font-size:11px;padding:4px 8px}.shop-currency-chip img{width:14px;height:14px}}
...
.punch-panel{position:relative;overflow:hidden;height:calc(100svh - 104px);background:radial-gradient(circle at 28% 12%,rgba(99,102,241,.16),transparent 42%),radial-gradient(circle at 80% 90%,rgba(244,63,94,.14),transparent 46%),linear-gradient(180deg,#0a0e1c,#05070f)}
#punchRoot{position:relative;z-index:1;height:100%}
.punch-stage{height:100%;display:grid;grid-template-columns:minmax(0,1.3fr) minmax(300px,.92fr);gap:clamp(16px,3vw,40px);align-items:stretch;width:min(1120px,94vw);margin:0 auto;padding:clamp(12px,2.4vw,28px) 0;overflow:hidden}
.punch-tabs{display:none}
.punch-machine{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:clamp(8px,1.6vw,16px);min-width:0;min-height:0;overflow:hidden;perspective:1100px}
.punch-machine-body{display:grid;grid-template-columns:auto auto;gap:clamp(12px,2.4vw,32px);align-items:center;justify-items:center;min-height:0}
.punch-machine-controls{display:flex;flex-direction:column;align-items:center;gap:clamp(10px,1.8vw,18px);min-width:0}
...
.punch-tower{width:clamp(150px,15vw,240px);height:auto;display:block;overflow:visible}
...
.punch-title-block{display:grid;gap:5px;text-align:center}
.punch-eyebrow{font-size:11px;font-weight:900;letter-spacing:.16em;color:#fca5a5}
.punch-title-block h2{margin:0;font-size:clamp(22px,3.4vw,38px);line-height:1;color:#fff;text-shadow:0 4px 22px rgba(0,0,0,.7),0 0 18px rgba(244,63,94,.22)}
.punch-sub{font-size:12px;color:#cbd5e1;font-weight:700}
.punch-lcd{position:relative;width:clamp(220px,22vw,290px);padding:14px 16px 10px;border-radius:14px;background:linear-gradient(165deg,#3a3f49,#1c2027 58%,#0f1217);border:1px solid rgba(0,0,0,.6);box-shadow:0 14px 30px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.14),inset 0 -3px 8px rgba(0,0,0,.55)}
...
.punch-lcd-ghost,.punch-lcd-value{display:block;text-align:right;font-family:'Courier New',ui-monospace,monospace;font-weight:900;font-style:italic;font-size:clamp(38px,6vw,54px);line-height:1;letter-spacing:5px;font-variant-numeric:tabular-nums}
...
.punch-dial{position:relative;width:clamp(180px,20vw,250px);aspect-ratio:1;display:grid;place-items:center;margin:2px 0}
...
/* 보상 화면 */
.punch-rewards{display:flex;flex-direction:column;gap:10px;min-width:0;min-height:0;background:rgba(5,8,18,.55);border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:14px;overflow:hidden}
.punch-rewards-head h3{margin:0;font-size:15px;font-weight:900;color:#fde68a;text-align:center;letter-spacing:.03em}
.punch-weekly{display:grid;grid-template-columns:auto 1fr;grid-template-areas:'badge badge' 'icon info';gap:5px 10px;align-items:center;padding:10px 12px;background:linear-gradient(135deg,rgba(251,191,36,.16),rgba(244,63,94,.07));border:1px solid rgba(251,191,36,.4);border-radius:12px;flex:0 0 auto}
.punch-weekly-badge{grid-area:badge;font-size:11px;font-weight:900;color:#fbbf24;letter-spacing:.03em}
.punch-weekly .punch-reward-thumb{grid-area:icon}
.punch-weekly-info{grid-area:info;min-width:0}
.punch-weekly-name{font-size:14px;font-weight:900;color:#fde68a;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.punch-weekly-note{font-size:11px;color:#94a3b8;font-weight:700}
.punch-tier-list{display:flex;flex-direction:column;gap:5px;min-height:0;overflow-y:auto;flex:1 1 auto}
.punch-tier-row{display:grid;grid-template-columns:74px auto 1fr;gap:8px;align-items:center;padding:5px 8px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.05);border-radius:8px}
.punch-tier-row.top{border-color:rgba(251,191,36,.5);background:rgba(251,191,36,.08)}
.punch-tier-range{font-size:11px;font-weight:900;color:#e5e7eb;font-variant-numeric:tabular-nums}
.punch-tier-icons{display:flex;gap:3px}
.punch-tier-name{font-size:11px;font-weight:700;color:#cbd5e1;line-height:1.25;overflow:hidden}
.punch-tier-tag{margin-left:5px;font-size:9px;font-weight:900;color:#fca5a5;background:rgba(244,63,94,.14);padding:1px 5px;border-radius:6px;white-space:nowrap}
.punch-reward-thumb{position:relative;width:30px;height:30px;flex:0 0 auto;display:grid;place-items:center}
.punch-reward-frame{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;z-index:1}
.punch-reward-icon{position:relative;z-index:2;width:74%;height:74%;object-fit:contain}
.punch-reward-fallback{position:relative;z-index:2;font-size:15px}
.punch-reward-count{position:absolute;right:-3px;bottom:-4px;z-index:3;font-size:9px;font-weight:900;color:#fff;background:rgba(0,0,0,.72);padding:0 3px;border-radius:5px;font-variant-numeric:tabular-nums}
.punch-rank{background:rgba(5,8,18,.5);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:10px 12px;flex:0 0 auto}
...
.punch-rank-row{display:grid;grid-template-columns:26px 1fr auto;gap:8px;align-items:center;padding:6px 9px;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.05);border-radius:9px;font-size:13px}
...
/* 결과/선택 모달 */
.punch-result-modal{display:grid;justify-items:center;gap:10px;padding:6px 0}
.punch-result-modal .punch-reward-thumb{width:76px;height:76px}
.punch-result-name{font-size:18px;font-weight:900;color:#fde68a;text-align:center}
.punch-result-sub{font-size:12px;color:#94a3b8}
.punch-choice-row{display:grid;grid-template-columns:1fr 1fr;gap:12px}
.punch-choice-btn{display:grid;justify-items:center;gap:8px;padding:16px 12px;background:rgba(255,255,255,.04);border:1.5px solid rgba(255,255,255,.12);border-radius:14px;cursor:pointer;transition:transform .12s,border-color .12s,background .12s;color:inherit}
.punch-choice-btn:hover{border-color:rgba(251,191,36,.7);background:rgba(251,191,36,.1);transform:translateY(-2px)}
.punch-choice-btn .punch-reward-thumb{width:64px;height:64px}
.punch-choice-name{font-size:14px;font-weight:900;color:#f8fafc;text-align:center}
@media(max-width:820px){
.punch-panel{height:calc(100svh - 124px)}
.punch-stage{grid-template-columns:1fr;grid-template-rows:auto minmax(0,1fr);width:100%;padding:10px 12px 14px;gap:10px}
.punch-tabs{display:flex;gap:8px;grid-row:1}
.punch-tab{flex:1;padding:10px 8px;border:1px solid rgba(255,255,255,.1);border-radius:10px;background:rgba(20,28,46,.7);color:#94a3b8;font-weight:800;font-size:14px;cursor:pointer;transition:all .12s}
.punch-tab.active{background:linear-gradient(135deg,#ef4444,#b91c1c);color:#fff;border-color:transparent;box-shadow:0 4px 12px rgba(239,68,68,.3)}
.punch-machine,.punch-rewards{display:none;grid-row:2;min-height:0}
.punch-machine.active,.punch-rewards.active{display:flex}
/* 머신: 타워를 좌측에 세우고 우측에 LCD·다이얼·토큰을 쌓아 세로 오버플로 방지 */
.punch-machine{justify-content:center;gap:8px;overflow:hidden}
.punch-machine .punch-title-block{gap:2px}
.punch-title-block h2{font-size:20px}
.punch-sub{font-size:11px}
.punch-machine-body{grid-template-columns:auto minmax(0,1fr);grid-template-areas:'tower controls';align-items:center;gap:12px;width:100%}
.punch-tower-wrap{grid-area:tower;transform:rotateY(-8deg)}
.punch-tower{width:clamp(76px,22vw,110px)}
.punch-machine-controls{grid-area:controls;gap:9px;width:100%}
.punch-lcd{width:100%;max-width:280px}
.punch-dial{width:min(200px,52vw)}
.punch-coin-btn{padding:9px 16px;font-size:13px}
/* 보상: 행 높이를 줄여 화면 안에 담기 */
.punch-rewards{padding:12px;gap:8px}
.punch-weekly{padding:8px 10px}
.punch-tier-row{grid-template-columns:64px auto 1fr;gap:6px;padding:4px 7px}
.punch-tier-range{font-size:10px}
.punch-tier-name{font-size:10px}
.punch-reward-thumb{width:26px;height:26px}
.punch-rank{padding:8px 10px}
.punch-rank-row{padding:5px 8px;font-size:12px}
.punch-choice-btn{padding:14px 10px}
}
...
.mail-pager,.auc-pager{display:flex;align-items:center;justify-content:center;gap:12px;padding:12px;border-top:1px solid rgba(148,163,184,.1);flex:0 0 auto}
.mail-pager button,.auc-pager button{padding:7px 13px;font-size:13px;background:rgba(88,101,242,.14);border:1px solid rgba(99,102,241,.3);color:#c7d2fe;border-radius:9px;font-weight:800;cursor:pointer}
.mail-pager button:disabled,.auc-pager button:disabled{opacity:.35;cursor:default}
.mail-pager .mail-page-info,.auc-pager .mail-page-info{font-size:13px;color:#94a3b8;font-variant-numeric:tabular-nums;font-weight:700}
.auc-pager{border-top:0;padding:14px 0 0}
