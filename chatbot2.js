...
const CHOSEONG_TOPICS = {
    과일: [
        ...
        '샤인머스캣', '청포도', '머루', '유자', '한라봉', '천혜향', '레드향', '금귤', '매실', '앵두',
        '산딸기', '복분자', '구아바', '코코넛', '패션프루트', '만다린', '천도복숭아', '플럼코트', '블랙베리', '보이젠베리',
        '구스베리', '카무카무', '스타프루트', '람부탄', '망고스틴', '자바애플', '용안', '살라크', '노니', '아사이베리',
        '엘더베리', '꾸지뽕', '아로니아', '오디', '비파'
    ],
    동물: [
        ...
        '고래', '상어', '문어', '오징어', '거북이', '미어캣', '카피바라', '천산갑', '알파카', '오카피',
        '나무늘보', '바다사자', '바다표범', '매너티', '듀공', '코뿔소', '타조', '홍학', '두루미', '캥거루',
        '왈라비', '하이에나', '스라소니', '담비', '족제비', '삵', '맹꽁이', '도롱뇽', '황소개구리', '청설모',
        '박쥐', '해달', '바다거북', '가젤', '영양'
    ],
    음식: [
        ...
        '제육볶음', '보쌈', '족발', '만두', '호떡', '육회비빔밥', '감자탕', '부대찌개', '해물순두부', '물회',
        '간장게장', '양념게장', '아귀찜', '해신탕', '곱창전골', '알탕', '닭한마리', '수제비', '칼국수', '잔치국수',
        '막국수', '쫄면', '비지찌개', '청국장', '동파육', '유린기', '마라탕', '마라샹궈', '양장피', '깐풍기',
        '팔보채', '고추잡채', '탄탄면', '규동', '스키야키'
    ]
};
