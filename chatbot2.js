...
const CHOSEONG_TOPICS = {
    과일: [
        ...
        '샤인머스캣', '청포도', '머루', '유자', '한라봉', '천혜향', '레드향', '매실', '앵두',
        '산딸기', '복분자', '구아바', '코코넛', '패션프루트', '만다린', '천도복숭아', '플럼코트', '블랙베리',
        '스타프루트', '망고스틴', '오디'
    ],
    동물: [
        ...
        '고래', '상어', '문어', '오징어', '거북이', '미어캣', '카피바라', '알파카',
        '나무늘보', '바다사자', '바다표범', '코뿔소', '타조', '홍학', '두루미', '캥거루',
        '하이에나', '담비', '족제비', '맹꽁이', '도롱뇽', '황소개구리', '청설모',
        '박쥐', '해달', '바다거북',
    ],
    음식: [
